...
Promotion to durable layers follows the memory promotion bar in `AGENTS.md § Memory promotion`. One-off observations stay in `ingestion/` until they accumulate.
